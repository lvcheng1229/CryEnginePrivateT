...
// Blend State factors - use only with macros GS_BLEND, BS_SET_SRC_COLOR, BS_SET_DST_COLOR, BS_SET_SRC_ALPHA or BS_SET_DST_ALPHA
#define BS_ZERO                           0x00000001
#define BS_ONE                            0x00000002
#define BS_SRC_COLOR                      0x00000003
#define BS_INV_SRC_COLOR                  0x00000004
#define BS_SRC_ALPHA                      0x00000005
#define BS_INV_SRC_ALPHA                  0x00000006
#define BS_DST_ALPHA                      0x00000007
#define BS_INV_DST_ALPHA                  0x00000008
#define BS_DST_COLOR                      0x00000009
#define BS_INV_DST_COLOR                  0x0000000A
#define BS_SRC_ALPHA_SAT                  0x0000000B
#define BS_SRC1_COLOR                     0x0000000C
#define BS_INV_SRC1_COLOR                 0x0000000D
#define BS_SRC1_ALPHA                     0x0000000E
#define BS_INV_SRC1_ALPHA                 0x0000000F // enum

#define BS_SRC_COLOR_MASK                 0x0000000F
#define BS_SRC_COLOR_SHIFT                0
#define BS_SRC_ALPHA_MASK                 0x000000F0
#define BS_SRC_ALPHA_SHIFT                4
#define BS_DST_COLOR_MASK                 0x00000F00
#define BS_DST_COLOR_SHIFT                8
#define BS_DST_ALPHA_MASK                 0x0000F000
#define BS_DST_ALPHA_SHIFT                12

#define BS_SET_SRC_COLOR(BS_STATE) ((BS_STATE) << BS_SRC_COLOR_SHIFT)
#define BS_SET_SRC_ALPHA(BS_STATE) ((BS_STATE) << BS_SRC_ALPHA_SHIFT)
#define BS_SET_DST_COLOR(BS_STATE) ((BS_STATE) << BS_DST_COLOR_SHIFT)
#define BS_SET_DST_ALPHA(BS_STATE) ((BS_STATE) << BS_DST_ALPHA_SHIFT)

// Blend State operations - use only with macros GS_BLEND, BS_SET_OP_COLOR or BS_SET_OP_ALPHA
#define BS_OP_ADD                         0x00
#define BS_OP_MAX                         0x01
#define BS_OP_MIN                         0x02
#define BS_OP_SUB                         0x03
#define BS_OP_INV_SUB                     0x04

#define BS_OP_COLOR_MASK                  0x00070000
#define BS_OP_COLOR_SHIFT                 16
#define BS_OP_ALPHA_MASK                  0x00380000
#define BS_OP_ALPHA_SHIFT                 19

// if no color blending operation is specified, Add is used as default
#define BS_SET_OP_COLOR(BS_OPERATION) ((BS_OPERATION) << BS_OP_COLOR_SHIFT)
// if no alpha blending operation is specified, Add is used as default
#define BS_SET_OP_ALPHA(BS_OPERATION) ((BS_OPERATION) << BS_OP_ALPHA_SHIFT)

// Macro for creating general blend states
#define GS_BLEND(SRC_COLOR, DST_COLOR, OP_COLOR, SRC_ALPHA, DST_ALPHA, OP_ALPHA)\
	(BS_SET_SRC_COLOR(SRC_COLOR) | BS_SET_DST_COLOR(DST_COLOR) | BS_SET_OP_COLOR(OP_COLOR) |\
	 BS_SET_SRC_ALPHA(SRC_ALPHA) | BS_SET_DST_ALPHA(DST_ALPHA) | BS_SET_OP_ALPHA(OP_ALPHA))

// The most common Source blend states
#define GS_BLSRC_ZERO                     (BS_SET_SRC_COLOR(BS_ZERO          ) | BS_SET_SRC_ALPHA(BS_ZERO)          )
#define GS_BLSRC_ONE                      (BS_SET_SRC_COLOR(BS_ONE           ) | BS_SET_SRC_ALPHA(BS_ONE)           )
#define GS_BLSRC_DSTCOL                   (BS_SET_SRC_COLOR(BS_DST_COLOR     ) | BS_SET_SRC_ALPHA(BS_DST_ALPHA)     )
#define GS_BLSRC_ONEMINUSDSTCOL           (BS_SET_SRC_COLOR(BS_INV_DST_COLOR ) | BS_SET_SRC_ALPHA(BS_INV_DST_ALPHA) )
#define GS_BLSRC_SRCALPHA                 (BS_SET_SRC_COLOR(BS_SRC_ALPHA     ) | BS_SET_SRC_ALPHA(BS_SRC_ALPHA)     )
#define GS_BLSRC_ONEMINUSSRCALPHA         (BS_SET_SRC_COLOR(BS_INV_SRC_ALPHA ) | BS_SET_SRC_ALPHA(BS_INV_SRC_ALPHA) )
#define GS_BLSRC_DSTALPHA                 (BS_SET_SRC_COLOR(BS_DST_ALPHA     ) | BS_SET_SRC_ALPHA(BS_DST_ALPHA)     )
#define GS_BLSRC_ONEMINUSDSTALPHA         (BS_SET_SRC_COLOR(BS_INV_DST_ALPHA ) | BS_SET_SRC_ALPHA(BS_INV_DST_ALPHA) )
#define GS_BLSRC_ALPHASATURATE            (BS_SET_SRC_COLOR(BS_SRC_ALPHA_SAT ) | BS_SET_SRC_ALPHA(BS_SRC_ALPHA_SAT) )
#define GS_BLSRC_SRCALPHA_A_ZERO          (BS_SET_SRC_COLOR(BS_SRC_ALPHA     ) | BS_SET_SRC_ALPHA(BS_ZERO)          )
#define GS_BLSRC_SRC1ALPHA                (BS_SET_SRC_COLOR(BS_SRC1_ALPHA    ) | BS_SET_SRC_ALPHA(BS_SRC1_ALPHA)    )
#define GS_BLSRC_SRC1ALPHA_A_ONE          (BS_SET_SRC_COLOR(BS_SRC1_ALPHA    ) | BS_SET_SRC_ALPHA(BS_ONE)           )
#define GS_BLSRC_MASK                     (BS_SRC_COLOR_MASK | BS_SRC_ALPHA_MASK)

// The most common Destination blend states																							    
#define GS_BLDST_ZERO                     (BS_SET_DST_COLOR(BS_ZERO          ) | BS_SET_DST_ALPHA(BS_ZERO)          )
#define GS_BLDST_ONE                      (BS_SET_DST_COLOR(BS_ONE           ) | BS_SET_DST_ALPHA(BS_ONE)           )
#define GS_BLDST_SRCCOL                   (BS_SET_DST_COLOR(BS_SRC_COLOR     ) | BS_SET_DST_ALPHA(BS_SRC_ALPHA)     )
#define GS_BLDST_ONEMINUSSRCCOL           (BS_SET_DST_COLOR(BS_INV_SRC_COLOR ) | BS_SET_DST_ALPHA(BS_INV_SRC_ALPHA) )
#define GS_BLDST_SRCALPHA                 (BS_SET_DST_COLOR(BS_SRC_ALPHA     ) | BS_SET_DST_ALPHA(BS_SRC_ALPHA)     )
#define GS_BLDST_ONEMINUSSRCALPHA         (BS_SET_DST_COLOR(BS_INV_SRC_ALPHA ) | BS_SET_DST_ALPHA(BS_INV_SRC_ALPHA) )
#define GS_BLDST_DSTALPHA                 (BS_SET_DST_COLOR(BS_DST_ALPHA     ) | BS_SET_DST_ALPHA(BS_DST_ALPHA)     )
#define GS_BLDST_ONEMINUSDSTALPHA         (BS_SET_DST_COLOR(BS_INV_DST_ALPHA ) | BS_SET_DST_ALPHA(BS_INV_DST_ALPHA) )
#define GS_BLDST_ONE_A_ZERO               (BS_SET_DST_COLOR(BS_ONE           ) | BS_SET_DST_ALPHA(BS_ZERO)          )
#define GS_BLDST_ONEMINUSSRC1ALPHA        (BS_SET_DST_COLOR(BS_INV_SRC1_ALPHA) | BS_SET_DST_ALPHA(BS_INV_SRC1_ALPHA))
#define GS_BLDST_ONEMINUSSRC1ALPHA_A_ZERO (BS_SET_DST_COLOR(BS_INV_SRC1_ALPHA) | BS_SET_DST_ALPHA(BS_ZERO)          )
#define GS_BLDST_MASK                     (BS_DST_COLOR_MASK | BS_DST_ALPHA_MASK)

// Predefined Color blend operation macros for backwards compatibility - use BS_SET_COLOR_OP instead
// if no color blending operation is specified, Add is used as default
#define GS_BLEND_OP_ADD            BS_SET_OP_COLOR(BS_OP_ADD)
#define GS_BLEND_OP_MAX            BS_SET_OP_COLOR(BS_OP_MAX)
#define GS_BLEND_OP_MIN            BS_SET_OP_COLOR(BS_OP_MIN)
#define GS_BLEND_OP_SUB            BS_SET_OP_COLOR(BS_OP_SUB)
#define GS_BLEND_OP_SUBREV         BS_SET_OP_COLOR(BS_OP_INV_SUB)

// Predefined Alpha blend operation macros for backwards compatibility - use BS_SET_ALPHA_OP instead
// GS_BLALPHA_MIN operation has been removed because it had a special behavior not aligned with the rest of the flags - it used to overwrite src and dst alpha factors with BS_ONE
// if no alpha blending operation is specified, Add is used as default
#define GS_BLALPHA_ADD             BS_SET_OP_ALPHA(BS_OP_ADD)
#define GS_BLALPHA_MAX             BS_SET_OP_ALPHA(BS_OP_MAX)
#define GS_BLALPHA_SUB             BS_SET_OP_ALPHA(BS_OP_SUB)
#define GS_BLALPHA_SUBREV          BS_SET_OP_ALPHA(BS_OP_INV_SUB)

#define GS_BLEND_MASK              (BS_SRC_COLOR_MASK | BS_SRC_ALPHA_MASK | BS_DST_COLOR_MASK | BS_DST_ALPHA_MASK | BS_OP_COLOR_MASK | BS_OP_ALPHA_MASK)

#define GS_DEPTHWRITE              0x00400000
#define GS_NODEPTHTEST             0x00800000
#define GS_STENCIL                 0x01000000
#define GS_ALPHATEST               0x200000000
								   
#define GS_COLMASK_SHIFT           28
#define GS_COLMASK_MASK            0xF0000000

// Color Exclusion Mask
// Note: Do not concatenate!
enum ColorMask : uint64
{
	GS_NOCOLMASK_NONE               = 0,
	GS_NOCOLMASK_R                  = 0x10000000,
	GS_NOCOLMASK_G                  = 0x20000000,
	GS_NOCOLMASK_B                  = 0x30000000,
	GS_NOCOLMASK_A                  = 0x40000000,
	GS_NOCOLMASK_GBA                = 0x50000000,
	GS_NOCOLMASK_RBA                = 0x60000000,
	GS_NOCOLMASK_RGA                = 0x70000000,
	GS_NOCOLMASK_RGB                = 0x80000000,
	GS_NOCOLMASK_RGBA               = 0x90000000,
	GS_NOCOLMASK_GBUFFER_OVERLAY    = 0xA0000000, // enum

	GS_NOCOLMASK_COUNT              = 0xB0000000,
};
static_assert(GS_NOCOLMASK_COUNT <= GS_COLMASK_MASK, "Exceeded count limit of possible color masks (16)");

#define GS_WIREFRAME               0x100000000

#define GS_DEPTHFUNC_LEQUAL        0x00000000
#define GS_DEPTHFUNC_EQUAL         0x02000000
#define GS_DEPTHFUNC_GREAT         0x04000000
#define GS_DEPTHFUNC_LESS          0x06000000
#define GS_DEPTHFUNC_GEQUAL        0x08000000
#define GS_DEPTHFUNC_NOTEQUAL      0x0A000000
#define GS_DEPTHFUNC_MASK          0x0E000000 // enum
#define GS_DEPTHFUNC_SHIFT         25
