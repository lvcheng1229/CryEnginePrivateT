...
static const D3D11_INPUT_ELEMENT_DESC VertexDecl_2U[] =
{
	...
	{ "LIGHTMAPUV"    , 0, DXGI_FORMAT_R32G32_FLOAT, VSF_LIGHTMAPUV, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 }
};
//TanGram:GIBaker:LightMapUV:BEGIN
...
void CDeviceObjectFactory::TrimResources()
{
	...
	// TODO: we should release per level vertex input layout and samplers here,
	// but currently we cannot reliably distinguish if they are per level or permanently needed
#ifdef TRIM_INPUT_LAYOUTS_AND_SAMPLERS
...
trimSamplerStatesDone:
	...
	if (!bCustomInputLayoutsInUse)
		TrimInputLayouts();
#endif // TRIM_INPUT_LAYOUTS_AND_SAMPLERS
}
