...
protected:
	...
	void ExecuteGeneratedCommandsImpl(CDeviceResourceIndirectLayoutPtr indirectLayoutPtr, CDeviceGraphicsPSOPtr graphicsPSOLayoutPtr, uint32 drawCount, CGpuBuffer* cmdBuffer, CGpuBuffer* preprocessBuffer, CGpuBuffer* countBuffer, uint32 countbufferOffset);//TanGram:VSM
...
protected:
	...
	void DispatchIndirectImpl(const CDeviceBuffer* pBuffer, uint32 Offset);//TanGram:TiledBloom
