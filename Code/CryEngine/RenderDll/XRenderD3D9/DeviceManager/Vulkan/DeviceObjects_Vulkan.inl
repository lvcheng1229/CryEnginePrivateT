...
static inline VkBufferUsageFlagBits ConvertToVKBufferUsageBits(const T& desc)
{
	...
	return VkBufferUsageFlagBits(
		...
		((desc & CDeviceObjectFactory::USAGE_ACCELERATION_STRUCTURE) ? (VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR | VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR | VK_BUFFER_USAGE_STORAGE_BUFFER_BIT) : 0) |
